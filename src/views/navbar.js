...
//     reader.onloadend = () => {
//       // reader.result will be a data URL: "data:<mime-type>;base64,<data>"
//       // We want just the base64 part, so we split at the comma.
...
//     const filename = `${user.username}_${moment().format("YYYYMMDD_HHmmss")}_${mediaFile.name}`;
...
//       setPostError("Error obtaining upload URL.");
//       return;
//     }
    
//     // Parse the result to extract the upload URL and final S3 URL
...
//       setPostError("Error uploading file to S3.");
//       return;
//     }
    
//     // Step 3: Now call your create post function with the S3 URL attached.
//     const postData = {
//       title: postTitle,
//       body: postBody,
//       tags: selectedTags,
//       media: s3_url, // The public S3 URL for the uploaded file
//       username: user.username,
...
//                   </div>
//                   <div className="mb-3">
//                     <label className="form-label">Tags (Select at least one)</label>
//                     <div>
//                       {tagOptions.map((tag) => (
//                         <div
